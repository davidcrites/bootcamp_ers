...
public interface EmployeeDAO {
	 ...
	 */
	Users loginEmployee(String username, String password);
	 ...
	 */
	void submitReimbursement(Reimbursement reimbRecord) throws SQLException;
	 ...
	 * @return
	 */
	List<Reimbursement> viewEmployeeTickets(int employeeId, boolean boolResolved, String ...Types);
