...
public class FinanceManagerMenuScreen {
	...
	public static void run(Users financeManager) {
		...
		while (choice ==0) {
			System.out.println("Hello, " + financeManager.getUserFirstName() + "!  Which of the following would you like to do:");
...
//				System.out.println("6) Approve or Deny a Reimbursement request");
				...
				while("undecided".equals(statusChange)) {
					System.out.println("What is the ID of the Reimbursement that you would like to approve or deny?");
					choice = scan.nextInt();
